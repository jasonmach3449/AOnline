...
<section className="bg-white dark:bg-gray-900">
    <div className="container px-6 py-10 mx-auto">
        <h1 className="text-3xl font-semibold text-gray-800 capitalize lg:text-4xl dark:text-white">استثمار <span className="underline decoration-blue-500">الاستراتيجيات</span></h1>
        
        <p className="mt-4 text-gray-500 xl:mt-6 dark:text-gray-300">
        منذ البداية، كانت شركتنا مدفوعة بالبحث المستمر عن أفكار جديدة حيث توسعنا عبر الاستراتيجيات والمناطق الجغرافية وفرص المواهب.
        </p>
        ...
        <div className="grid grid-cols-1 gap-8 mt-8 xl:mt-12 xl:gap-12 md:grid-cols-2 xl:grid-cols-3">
            <div className="p-8 space-y-3 border-2 border-blue-400 dark:border-blue-300 rounded-xl">
                ...
                <h1 className="text-2xl font-semibold text-gray-700 capitalize dark:text-white">شراء وعقد</h1>

                <p className="text-gray-500 dark:text-gray-300">
                تستفيد من النمو على المدى الطويل من خلال الاحتفاظ بعملات مشفرة قوية، بهدف تحقيق ارتفاع كبير بمرور الوقت على الرغم من التقلبات قصيرة المدى.
                </p>
            ...
            <div className="p-8 space-y-3 border-2 border-blue-400 dark:border-blue-300 rounded-xl">
                ...
                <h1 className="text-2xl font-semibold text-gray-700 capitalize dark:text-white">متوسط ​​تكلفة الدولار</h1>

                <p className="text-gray-500 dark:text-gray-300">
                يقلل من مخاطر توقيت السوق من خلال استثمار مبالغ ثابتة بانتظام، وتخفيف التقلبات وتجميع الأصول تدريجياً مع مرور الوقت.
                </p>
            ...
            <div className="p-8 space-y-3 border-2 border-blue-400 dark:border-blue-300 rounded-xl">
                ...
                <h1 className="text-2xl font-semibold text-gray-700 capitalize dark:text-white">الزراعة المساحية والمحصولية</h1>

                <p className="text-gray-500 dark:text-gray-300">
                يمكنك توليد دخل سلبي عن طريق قفل العملات المشفرة في شبكات PoS أو منصات DeFi، وكسب المكافآت أو الفوائد بمرور الوقت.
                </p>
            ...
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 4v16m8-8H4" />
                ...
                <h1 className="text-2xl font-semibold text-gray-700 capitalize dark:text-white">التداول المتأرجح</h1>

                <p className="text-gray-500 dark:text-gray-300">
                الأرباح من تقلبات الأسعار قصيرة المدى من خلال تحليل الاتجاهات، والشراء بسعر منخفض، والبيع بسعر مرتفع على مدار أيام أو أسابيع.
                </p>
