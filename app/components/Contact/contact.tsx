...
const ContactForm = () => {
  return (
    <div>
      {/* Include the Tailwind CSS via CDN in your public/index.html file */}
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="grid lg:grid-cols-2 grid-cols-1">
                    ...
                    <div className="absolute bottom-0 w-full lg:p-11 p-5">
                      <div className="bg-white rounded-lg p-6 block">
                        ...
                        <a href="javascript:;" className="flex items-center">
                          ...
                          <h5 className="text-black text-base font-normal leading-6 ml-5">
                          PB 767649 - 6 Sheikh Fatima bint Mubarak St - Zone 1E8 - Zone 1 - Abu Dhabi - United Arab Emirates
                          </h5>
                        </a>
                      </div>
                    </div>
              ...
              <div className="bg-gray-50 p-5 lg:p-11 lg:rounded-r-2xl rounded-2xl">
                ...
                أرسل لنا رسالة أو بريد إلكتروني
                </h2>
                <input
                  type="text"
                ...
                <button
                  type="submit"
                  className="w-full h-12 text-black text-base font-semibold leading-6 rounded-full transition-all duration-700 hover:bg-indigo-800 bg-blue-600 !bg-blue-600 shadow-sm"
                >
                  Send
                </button>
              </div>
